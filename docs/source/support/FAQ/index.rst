...
数据集健康检查提示验证和测试集中没有缺陷图像
--------------------------------------------------

    当您遇到下图这种情况时、您可以手动将缺陷数据重新分配调整一下。

    .. image:: images/数据健康检测报错.png
        :align: center
        :scale: 100%
    
    - 在“图像”中选择好一整缺陷的数据、将已选择的数据手动分配到验证集或测试集中。

    .. image:: images/手动分配数据集.png
        :align: center
        :scale: 50%


在SDK中报opencv无法读取中文路径？
--------------------------------------------------
    - 解决方案：在系统设置中，勾选“添加 UTF-8 全球语言支持”选项，以确保系统能够全面支持多种语言的编码，从而解决可能出现的语言兼容性问题。

    - 操作步骤："控制面板-时钟和区域-区域-管理-更改系统区域设置-勾选UTF-8提供全球语言支持-确认”。
