...
.. tabs::
    ...
    .. tab:: 标注工具
        ...
        在 **实例分割** 和 **关键点检测** 项目中，您可以使用一下标注工具完成标注：
